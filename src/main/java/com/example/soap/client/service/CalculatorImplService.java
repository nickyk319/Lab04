 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://service.soap.example.com/", wsdlLocation = "http://localhost:8090/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://service.soap.example.com/", "CalculatorImplService");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://service.soap.example.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap.example.com/", "CalculatorImplPort"), Calculator.class, features);
    }
